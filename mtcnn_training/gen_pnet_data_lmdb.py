...
pos_save_dir = r"..\data\mtcnn_training\{0:d}net\positive".format(image_size)
part_save_dir = r"..\data\mtcnn_training\{0:d}net\part".format(image_size)
neg_save_dir = r'..\data\mtcnn_training\{0:d}net\negative'.format(image_size)
save_dir = r'..\data\mtcnn_training\{0:d}net'.format(image_size)
...
cls_list_file = r"..\data\mtcnn_training\{0:d}net\cls.imdb".format(image_size)
...
roi_list_file = r"..\data\mtcnn_training\{0:d}net\roi.imdb".format(image_size)
