...
flags.DEFINE_string('log_file', 'gen_landmark_aug_12', 'log filename')
...
def GenerateData(data_path, ftxt, out_dir, dstdir, net_name, argument=False):
    ...
    image_id = 0
    #
    ftxt = open(join(out_dir,"landmark_%s_aug.txt" %(size)),'w')
