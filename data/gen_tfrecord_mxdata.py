...
def arg_parse():
    ...
    print(f'config.mxdata_dir: {config.mxdata_dir}')
    print(f'config.tfrecord_dir: {config.tfrecord_dir}')
...
def main():
    ...
    with  tf.compat.v1.python_io.TFRecordWriter(save_dir) as writer:
